package org.robotrunk.rpc.conf
{
	...
	import org.robotrunk.rpc.error.RemoteObjectRegistrationException;
	...
	public class RpcBootstrapHelper
	{
		...
		private function registerRemoteClassAliasOrThrowException ( field : XML ) : void
		{
			...
			{
				throw new RemoteObjectRegistrationException ( "Could not register class alias for type:" + field.name + " due to:" + e.message );
			}
		}
